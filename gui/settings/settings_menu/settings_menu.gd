extends Control
## Assistente de configurações usado antes da primeira fase e pelo menu de pausa.
...
@onready var pages: Array[Control] = [
	$Overlay/Panel/Margin/Body/Content/Pages/VisualPage,
	$Overlay/Panel/Margin/Body/Content/Pages/ControlsPage,
	$Overlay/Panel/Margin/Body/Content/Pages/AudioDialoguePage,
]
