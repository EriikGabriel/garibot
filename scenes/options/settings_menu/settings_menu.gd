...
var current_step := 0
@onready var pages: Array[Control] = [$Overlay/Panel/Margin/Body/Content/Visual, $Overlay/Panel/Margin/Body/Content/Controls, $Overlay/Panel/Margin/Body/Content/Audio]
