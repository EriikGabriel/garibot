...
func _ready():
	...
	$SongSelect.select(10)
	$SongSelect2.select(11)
	...
	$FadeSelect.add_item("play_switch")
	$FadeSelect.add_item("switch")
	$FadeSelect.add_item("pause")
	$FadeSelect.add_item("resume")
...
func _on_Button_pressed():
	match $FadeSelect.selected:
		...
		7: sound_manager.play_switch($SongSelect.get_item_text($SongSelect.selected), $SongSelect2.get_item_text($SongSelect2.selected))
		8: sound_manager.switch()
		9: sound_manager.pause()
		10: sound_manager.resume()
